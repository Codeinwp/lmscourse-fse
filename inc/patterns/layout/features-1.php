...
return array(
	...
	'keywords'   => array( 'content', 'features', 'grid' ),
	'content'    => '
...
<h3 class="wp-block-heading has-text-align-left">Strum Ipsum</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"left"} -->
<p class="has-text-align-left">Pickum chordis dolor sit fretboard, consectetur scale-tur adipiscing neck. Solo elit string-tremolo.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:paragraph -->
<p>Pickum chordis dolor sit fretboard, consectetur scale-tur adipiscing neck. Solo elit string-tremolo.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

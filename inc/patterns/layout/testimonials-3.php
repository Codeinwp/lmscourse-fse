...
<!-- wp:group {"metadata":{"name":"testimonials-3"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"var:preset|spacing|40","right":"var:preset|spacing|40"},"margin":{"top":"0","bottom":"0"},"blockGap":"var:preset|spacing|80"}},"backgroundColor":"ti-bg","layout":{"type":"constrained"}} -->
...
<p class="has-text-align-left has-normal-font-size">“Pickum chordis dolor sit fretboard, consectetur scale-tur adipiscing neck.</p>
<!-- /wp:paragraph -->

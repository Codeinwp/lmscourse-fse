# Agent Guide — LMSCourse FSE

## Overview

LMSCourse FSE is a block-based WordPress theme built for Full Site Editing. PHP theme code lives in the `LMSCourseFSE` namespace under `inc/`; the theme also provides block patterns, templates, template parts, styles, and JavaScript and SCSS assets.
...
- Put PHP theme behavior in the existing `LMSCourseFSE` namespace and preserve the current class structure.

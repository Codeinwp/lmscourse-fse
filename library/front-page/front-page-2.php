...
<!-- wp:pattern {"slug":"church-fse/layout/hero-with-feature-columns"} /-->

<!-- wp:pattern {"slug":"church-fse/layout/columns-content-images"} /-->

<!-- wp:pattern {"slug":"church-fse/layout/columns-with-services-text"} /-->
